...
const About = () => {
  ...
  return (
    <section id="sobre" ref={ref}>
      {/* Stats Bar */}
      <div className="dark-section py-16 md:py-20">
        <div className="container-narrow px-6 md:px-10 lg:px-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            {stats.map((stat, i) => (
              ...
              >
                ...
                <p className="text-dark-muted text-sm mt-2 tracking-wide uppercase font-sans">{stat.label}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="container-narrow">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-foreground leading-[1.1] mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {differentials.map((item, i) => (
                <motion.div
                  ...
                  className="group p-6 border border-border hover:border-primary/30 transition-all duration-500 hover:shadow-card"
                >
                  <item.icon className="text-primary mb-4 group-hover:scale-110 transition-transform duration-300" size={28} strokeWidth={1} />
