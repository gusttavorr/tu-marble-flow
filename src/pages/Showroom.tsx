        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="flex flex-col gap-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-serif text-lg font-medium text-foreground mb-1">Showroom — São Paulo</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Alameda Gabriel Monteiro da Silva, 278<br />
                  Jardim América — São Paulo/SP
                </p>
                <h3 className="font-serif text-lg font-medium text-foreground mb-1 mt-4">Fábrica — Arujá</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Alameda das Azaléias, 628<br />
